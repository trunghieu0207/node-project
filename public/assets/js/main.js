...
(function () {
    ...
    function switchImage(style) {
        ...
        switchImagesList.map(function (imageEl) {
            ...
            imageEl.src = domainUrl + 'img/' + setImage; // Using window.assetsPath to get the exact relative path
        });
    }
    ...
    //             fallbackLng: 'en',
    //             backend: {
    //                 loadPath: domainUrl + 'json/locales/{{lng}}.json',
    //             },
    //             returnObjects: true,
    //         })
    //         .then(function (t) {
...
if (typeof $ !== 'undefined') {
    $(function () {
        ...
        if (searchInput.length) {
            ...
            // var searchData = $.ajax({
            //     url: domainUrl + 'json/' + searchJson, //? Use your own search api instead
            //     dataType: 'json',
            //     async: false,
            // }).responseJSON;
