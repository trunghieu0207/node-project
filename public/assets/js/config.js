...
let domainUrl = `${protocol}//${url}`;

if (port) {
    domainUrl = `${protocol}//${url}:${port}`;
}
...
if (typeof TemplateCustomizer !== 'undefined') {
    window.templateCustomizer = new TemplateCustomizer({
        cssPath: domainUrl + '/static/assets/vendor/css' + (rtlSupport ? '/rtl' : '') + '/',
        themesPath: domainUrl + '/static/assets/vendor/css' + (rtlSupport ? '/rtl' : '') + '/',
