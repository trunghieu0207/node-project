...
export const haveFlash = (
    ...
    return req.session[sessionKeyName][type];
};

export const expressFlashMessage = (option: FlashOption) => {
        ...
        res.render = function (
            ...
            originalRender(
                view,
                {
                    ...
                    haveFlash: (type: string) =>
                        haveFlash(req, sessionKeyName, type, onConsumeFlash)
                },
                callback
            );
        };
